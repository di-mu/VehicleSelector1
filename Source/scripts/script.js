window.addEventListener("load", function(event){
	...
	document.getElementById("carTypes").addEventListener("click", selectBody);
});
...
function selectModel(event) {
	...
	if (model==1 && ((row==1 && col==1) || (row==2 && col==3))) {
		sel.innerHTML = "\
			<ul>\
			  <li class='menu' onmousedown='selectTrim(1)' >Trim 1</li>\
			  <li class='menu' onmousedown='selectTrim(2)' >Trim 2</li>\
			  <li class='menu' onmousedown='selectTrim(3)' >Trim 3</li>\
			</ul>\
			<br><br>\
			<div id='carTrim'>\
